    ...
    <section>
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
                ...
                <h3 class="text-2xl font-bold text-center">Update Details</h3>
                <form action="validation.php" method="POST">
                    <div class="mt-4">
                        <div>
                            <label class="block" for="Name">Name<label>
                                    <input type="text" placeholder="Name" name="name"
                                        class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600" value="value_from_db">
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <label class="block">Profile photo<label>
                                    <input type="file" accept="image/png, image/gif, image/jpeg" class="w-full p-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 text-sm">
                        </div>
                        <span class="text-xs text-red-400" id="inf">Passwords must be same!</span>
                        <div class="flex">
                            <button id="btn_r" type="submit" name="reg_btn"
                                class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900" disabled>Update</button>
                        </div>
                    </div>
                </form>
            </div>
