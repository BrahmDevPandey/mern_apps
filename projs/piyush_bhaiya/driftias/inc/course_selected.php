...
<body>
  <section class="px-2 py-32 md:px-0">
    ...
    <section class="w-full   pb-7 md:pt-2 md:pb-24 flex justify-center">
      ...
      <a type="button" href="course_selected.php"
        class="shadow-lg text-red-900 border-2  bg-none hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-24 py-10 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
        Optional
      </a>
      <a type="button" href="course_selected.php"
        class="shadow-lg text-red-900 border-2  bg-none hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-24 py-10 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
    ...
    <div class="input-page mb-5 " id="input-page">
      <div class="flex  justify-center items-center w-full choose-file">
        <label for="dropzone-file"
          class="flex flex-col mx-auto justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
    ...
    <div id="btns"
      class="flex flex-col      cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
      <button type="button" style="display: none;" onClick={embedImages()} id="convertBtn" convertBtn={convertBtn}
