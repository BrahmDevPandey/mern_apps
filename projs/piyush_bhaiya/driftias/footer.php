<footer class="px-4 divide-y text-red-900 dark:bg-gray-800 dark:text-gray-100">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<div class="flex items-center justify-center w-12 h-12 rounded-full dark:bg-blue-400">
					<img src="https://ik.imagekit.io/d12g1stmy/-2147483648_-213846-removebg-preview.png?ik-sdk-version=javascript-1.4.3&updatedAt=1668525757495" class="mr-3 h-8" alt="DRIFTIAS Logo">
				</div>
				<span class="self-center text-2xl font-semibold">DriftIAS</span>
			</a>
		</div>
	...
	<div class="py-6 text-sm text-center dark:text-gray-400">© 2022 Company Co. All rights reserved.</div>
</footer>
    <!-- Back to top button -->
    <button id="to-top-button" onclick="goToTop()" title="Go To Top"
        class="hidden fixed z-90 bottom-8 right-8 border-0 w-16 h-16 rounded-full drop-shadow-md bg-indigo-500 text-red-900 text-3xl font-bold">&uarr;</button>
