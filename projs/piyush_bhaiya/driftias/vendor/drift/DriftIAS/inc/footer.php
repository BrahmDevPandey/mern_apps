...
<footer class="p-4  sm:p-6 dark:bg-gray-900" style="background-color: #640434;color:white">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" class="hover:underline">DriftIAS</a>. All Rights Reserved.
        </span>
