...
<body>
                    ...
                    <div
                        ...
                        <h1
                            ...
                            <span class="block xl:inline">
                                <?php echo $data['header1']; ?>
                            </span><br>
                            <span class="block  xl:inline" style="color:#830e5e">
                                <?php echo $data['header2']; ?>
                            </span>
                        </h1>
                        ...
                        <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                            <a href="login.php"
                                class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white  rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto"
                                style="background-color: #830e5e;">
                                Try It Free
                            ...
                            <a href="#_" style="background-color:#ac8c94;color:black"
                                class=" font-extrabold flex items-center px-6 py-3 text-black-500  rounded-md hover:bg-gray-200 hover:text-gray-600">
                                Learn More
                            </a>
                        </div>
                    </div>
    ...
    <section class="w-full   pb-7 md:pt-2 md:pb-24">
        <div
            ...
            <div
                ...
                <img src="https://img.icons8.com/external-xnimrodx-lineal-color-xnimrodx/512/000000/external-interview-communication-xnimrodx-lineal-color-xnimrodx.png"
            ...
            <div class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
                ...
                <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
                    <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-red-900 rounded-full"><span
    ...
    <section class="w-full   pb-7 md:pt-2 md:pb-24">
        <div
            ...
            <div
                ...
                <img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/512/000000/external-affordable-cleaning-flaticons-lineal-color-flat-icons-2.png"
                    class="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20 " />
        ...
        <div
            ...
            <div
                class="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
                <img src="https://img.icons8.com/pastel-glyph/512/000000/estimated-growth.png"
    ...
    <?php include 'sample_evolutions.php'; ?>
    <!-- Section 6 -->

    <section id="Evaluation"
        class="box-border py-8 leading-7 text-gray-900  border-0 border-gray-200 border-solid sm:py-12 md:py-16 lg:py-24">
        <div class="box-border max-w-6xl px-4 pb-12 mx-auto border-solid sm:px-6 md:px-6 lg:px-4">
            <div class="flex flex-col items-center leading-7 text-center text-gray-900">
                <h2
                    class="box-border underline dark:text-white decoration-blue-500 m-0 text-3xl font-semibold leading-tight tracking-tight text-black border-solid sm:text-4xl md:text-5xl">
                    Evaluation Plans
                </h2>
            ...
            <div class="mb-4 border-b border-gray-200 flex justify-center  dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-lg font-medium text-center" id="myTab"
                    data-tabs-toggle="#myTabContent" role="tablist">
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="profile-tab"
                            data-tabs-target="#profile" type="button" role="tab" aria-controls="profile"
                            aria-selected="false">GS/ESSAY</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button
                            class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab"
                            aria-controls="dashboard" aria-selected="false">Optional</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button
                            class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="settings-tab" data-tabs-target="#settings" type="button" role="tab"
                            aria-controls="settings" aria-selected="false">Combo</button>
                    </li>
                ...
                <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="profile" role="tabpanel"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="flex items-center justify-center mt-6 leading-7 text-gray-900 border-0 border-solid sm:mt-8">
                                <p
                                    class="box-border m-0 text-6xl font-semibold leading-normal text-center border-0 border-gray-200">
                                    $
                                    <?php echo $data2[0][3]; ?>
                                </p>
